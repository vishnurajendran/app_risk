 ...
 */
public class TournamentMock implements ISubApplication {
    private ArrayList<String> d_supportedCmd = new ArrayList<>(Arrays.asList(ApplicationTestConstants.TOURNAMENT_TEST_CMD));
